...
describe Merchant, type: :model do
  ...
  describe 'instance methods' do
    ...
    it 'distinct_cities' do
      ...
      user.orders.create(name: 'Brian', address: '123 Brian Ave', city: 'Denver', state: 'CO', zip: 17033)
      order_2 = Order.last
      order_2.item_orders.create!(item: chain, price: chain.price, quantity: 2)

      user.orders.create(name: 'Dao', address: '123 Mike Ave', city: 'Denver', state: 'CO', zip: 17033)
      order_3 = Order.last
